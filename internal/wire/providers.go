...
func ProvideMCPService(repoManager repository.RepositoryManager, googleaiService *service.GoogleAIService, logger *zap.Logger) service.MCPService {
	userService := service.NewUserServiceAdapter(repoManager)
	return service.NewMCPService(userService, googleaiService, logger)
}
